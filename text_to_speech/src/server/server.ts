...
import { createTextToSpeechAudio, createTextToSpeechAudioforone } from "./TextToSpeech";
...
export const startServer = () => {
  ...
  app.post(`/getdataforone`, async (req, res) => {
    try {
      const data = req.body as Indmetadata;

      const audioURL = await createTextToSpeechAudioforone({ ...data });
